...
static const char col_maroon[]		= "#704344";
...
static const char col_cream2[]		= "#D1CBBF";
...
static const char *colors[][3]      = {
	/*               bar fg         bg bg         border   */
	[SchemeNorm] = { col_cream2, col_maroon, col_cream2 },	// blue cream theme

	/*               bar fg         bg bg         border   */
	[SchemeSel]  = { col_maroon, col_cream2, col_maroon },	// blue cream theme
